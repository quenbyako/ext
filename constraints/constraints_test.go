...
import "github.com/quenbyako/ext/constraints"
type (
...
func TestFailure(t *testing.T) {
	...
	// This package is github.com/quenbyako/ext/constraints, so the root of the x/exp
...
go 1.18
replace github.com/quenbyako/ext => %s
`, expModDir)
